...
const ComposeForm = () => {
        ...
        return (
            <div className="w-full max-w-lg mx-auto bg-zinc-900/50 backdrop-blur-md p-6 rounded-xl border border-zinc-800 animate-fade-in">
                <div className="mb-6 text-center">
                    ...
                    <h2 className="text-xl font-medium text-slate-100 mb-1">Link Ready</h2>
                    <p className="text-slate-500 text-sm">Share this link carefully. It will vanish after use.</p>
                </div>
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto bg-zinc-900/50 backdrop-blur-md p-6 rounded-xl border border-zinc-800">
            <div className="mb-5">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                    <label className="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">View Limit</label>
                    <div className="relative">
                        ...
                        <ChevronDown className="absolute right-2 top-1/2 transform -translate-y-1/2 text-slate-500 pointer-events-none" size={16} />
                    </div>
                </div>
                <div>
                    <label className="block text-xs font-medium text-slate-500 mb-1.5 uppercase tracking-wide">Expiration</label>
                    <div className="relative">
                        <select
                            value={expiration}
            ...
            <button
                ...
                className="w-full py-2 bg-indigo-600 hover:bg-indigo-800 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-md transition-all flex item-center justify-center gap-2 text-sm"
            >
                {loading ? <Loader2 className="animate-spin" size={16} /> : 'Create Secret Link'}
            </button>
        </form>
    );
};
